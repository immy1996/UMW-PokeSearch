...
INSERT INTO pokemon (name, image, weight, height, male, female, hp, attack, defense, sp_attack, sp_defense, speed, total_rating, evolves_into)  VALUES ('Blastoise', 'Blasoise.jpg', 188.5, 5.03, 87.5, 12.5, 79,83,100,85,105,78,530, 'None');
...
INSERT INTO pokemon (name, image, weight, height, male, female, hp, attack, defense, sp_attack, sp_defense, speed, total_rating, evolves_into)  VALUES ('Nidoran', 'Nidoran-f.jpg', 15.4, 1.04, 0.0, 100.0, 55, 47, 52, 40, 40, 41, 275, 'Nidorina');
...
INSERT INTO pokemon (name, image, weight, height, male, female, hp, attack, defense, sp_attack, sp_defense, speed, total_rating, evolves_into)  VALUES ('Nidoran', 'Nidoran-m.jpg', 19.8, 1.07, 100.0, 0.0, 46, 57, 40, 40, 40, 50, 273, 'Nidorino');
...
INSERT INTO pokemon (name,  image, weight, height, male, female, hp, attack, defense, sp_attack, sp_defense, speed, total_rating, evolves_into)  VALUES ('Primeape', 'Primape.jpg', 70.5, 3.03, 50.0, 50.0, 65, 105, 60, 60, 70, 95, 455, 'None');
